...
abstract class MathRenderer {
	...
	protected $displayStyle = MW_MATHSTYLE_INLINE_DISPLAYSTYLE;
	/**
	...
	public static function getRenderer( $tex, $params = array(),  $mode = MW_MATH_PNG ) {
		...
		if ( isset( $params['display'] ) ) {
			...
			if ( $layoutMode == 'block' ) {
				$displayStyle = MW_MATHSTYLE_DISPLAY ;
				...
				$displayStyle = MW_MATHSTYLE_INLINE;
				$tex = '{\textstyle ' . $tex . '}';
			}
		}
	...
	/**
	 *
	 * @param (MW_MATHSTYLE_INLINE_DISPLAYSTYLE|MW_MATHSTYLE_DISPLAY|MW_MATHSTYLE_INLINE) $displayStyle
	 */
	public function setDisplayStyle( $displayStyle = MW_MATHSTYLE_DISPLAY ) {
