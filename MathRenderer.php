...
abstract class MathRenderer {
			...
			$dbw
				->onTransactionIdle ( 
					function () use ($dbw, $outArray) {
						$dbw
							->replace ( 'math', array('math_inputhash'), $outArray, __METHOD__ );
					} );
		}
	}
	...
	/**
	 * @param unknown_type $conservativeness
	 */
