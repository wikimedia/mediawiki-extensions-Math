...
class MathMathML extends MathRenderer {
	...
	public function getHtmlOutput() {
		...
		$output .= Xml::tags( $element, array( 'class' => $this->getClassName(),
			'style'=>'display: none;' ),
			$mml );
		//That's the desired way to include svg images, however due to stylesheet issues it's not possible now
		//$output .= $this->getFallbackImage( false ) . "\n";
		$output .= Xml::tags( $element, array( 'class' => $this->getClassName(true) ),
			$this->getSvg() );
