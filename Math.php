 ...
 * servers in an array e.g $wgLaTeXMLUrl = array ( 'http://latexml.physikerwelt.de/convert', 
 * 'http://latexml2.physikerwelt.de/convert');
 */
...
$wgUseLaTeXML = false;
/**
 * The timeout for the LaTeXML server to render an equaiton, in seconds.
 */
