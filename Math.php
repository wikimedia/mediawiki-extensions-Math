...
$wgResourceModules += array(
	...
	'ext.math.mathjax.jax.element.mml' => array(
		...
		'scripts' => array('jax.js','optable/Arrows.js','optable/BasicLatin.js','optable/CombDiacritMarks.js','optable/CombDiactForSymbols.js','optable/Dingbats.js','optable/GeneralPunctuation.js','optable/GeometricShapes.js','optable/GreekAndCoptic.js','optable/Latin1Supplement.js','optable/LetterlikeSymbols.js','optable/MathOperators.js','optable/MiscMathSymbolsA.js','optable/MiscMathSymbolsB.js','optable/MiscSymbolsAndArrows.js','optable/MiscTechnical.js','optable/SpacingModLetters.js','optable/SupplementalArrowsA.js','optable/SupplementalArrowsB.js','optable/SuppMathOperators.js'),
		'dependencies' => 'ext.math.mathjax'
	),
	...
	'ext.math.mathjax.jax.input.MathML' => array(
		'localBasePath' => dirname( __FILE__ ) . '/modules/MathJax/unpacked',
		'remoteExtPath' => 'Math/modules/MathJax/unpacked',
		'scripts' => array('jax/input/MathML/jax.js'),
		'dependencies' => array('ext.math.mathjax.jax.config', 'ext.math.mathjax.jax.element.mml')
	),
	...
	'ext.math.mathjax.all' => array(
                'dependencies' => array('ext.math.mathjax.localization','ext.math.mathjax.jax.input.TeX','ext.math.mathjax.jax.input.MathML','ext.math.mathjax.jax.output.NativeMML','ext.math.mathjax.ui')
        )
);
