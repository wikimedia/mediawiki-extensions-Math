...
class MathLaTeXMLTest extends MediaWikiTestCase {
	...
	public function testSerializeSettings() {
		$renderer = $this->getMockBuilder( 'MathLaTeXML' )->setMethods( NULL )->disableOriginalConstructor()->getMock();
		$sampleSettings = array( 'k1' => 'v1', 'k2&=' => 'v2 + & *üö', 'k3' => array( 'v3A', 'v3b' ) );
	...
	public function testIntegration() {
		...
		$this->assertEquals( $expected, $real, "Rendering of a+b in plain Text mode." . $renderer->getLastError() );
	}
}
