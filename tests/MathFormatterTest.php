...
class MathFormatterTest extends MediaWikiTestCase {
	...
	"Unknown format " . self::FORMAT_UNKNOWN . "</strong>";
	const FORMAT_VALUE = "";
	...
	/**
	 * @expectedException IllegalValueException
	 */
	public function testNotStringValue() {
		$formatter = new MathFormatter( self::FORMAT_PLAIN );
		$resultFormat = $formatter->format( new NumberValue() );
	}
	...
	public function testNullValue() {
		$formatter = new MathFormatter( self::FORMAT_PLAIN );
		$resultFormat = $formatter->format( null );
	}
