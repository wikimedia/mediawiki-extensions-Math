...
class MathHooks {
	...
	static function onLoadExtensionSchemaUpdates( $updater = null ) {
		...
		if ( in_array( MW_MATH_LATEXML, $GLOBALS['wgMathValidModes'] ) ) {
		...
		if ( in_array( MW_MATH_MATHML, $GLOBALS['wgMathValidModes'] ) ) {
			if ( in_array( $type, array( 'mysql', 'sqlite', 'postgres' ) ) ) {
