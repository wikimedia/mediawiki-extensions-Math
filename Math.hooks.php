	...
	public static function onWikibaseRepoDataTypes( array &$dataTypeDefinitions ) {
		$dataTypeDefinitions['PT:math'] = array(
				...
				'validator-factory-callback' => function() {
					...
					// add our MathValidator
					$validators[] = new MathValidator();

					// return a composite validator which calls the validate()-functions of all
					// registered validators
					// iterative and fails if one sub-validator does
					return array( new CompositeValidator( $validators ) );
				},
