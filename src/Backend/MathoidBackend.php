...
class MathoidBackend {
	...
	public const ENDPOINT_CHECK = 'texvcinfo';
	public const ENDPOINT_RENDER = 'complete';
	private const VALID_ENDPOINTS = [ self::ENDPOINT_RENDER, self::ENDPOINT_CHECK ];
	...
	public function __construct(
		...
		if ( !( in_array( $endpoint, self::VALID_ENDPOINTS ) ) ) {
			throw new MWException( "'$endpoint' is not a valid Mathoid endpoint." );
		}
